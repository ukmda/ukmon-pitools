...
def test_xmlcreatorName(dir_file = 'FF_UK001L_20230319_031241_804_0598784.fits',
                        expectedname='FF_UK001L_20230319_031241_804_0598784.xml', srcdir='ukml/pi/uk001l',
                        camloc = 'tackley_ne'):
    cap_dir = os.path.join(basedir, srcdir)
    cfg = loadConfigFromDirectory('.config', cap_dir)
    fullxml = os.path.join(tmpdir, expectedname)
    sendToLive.createXMLfile(fullxml, cap_dir, dir_file, camloc, cfg)
    assert os.path.isfile(fullxml)
...
def test_xmlUK008t():
    ...
    expname = 'FF_UK008T_20230213_025907_432_0828928.xml'
...
def test_uk008tData():
    test_xmlData(xmlfile='FF_UK008T_20230213_025907_432_0828928.xml', testval=84707799)
...
def test_uk008tDataV2():
    test_xmlData(xmlfile='FF_UK008T_20230213_025907_432_0828928.xml', testval=234177206)


def test_xmlUK0045():
    dir_file = 'FF_UK0045_20230213_025919_082_0831744.fits'
    expname = 'FF_UK0045_20230213_025919_082_0831744.xml'
...
def test_uk0045Data():
    test_xmlData(xmlfile='FF_UK0045_20230213_025919_082_0831744.xml', testval=233153959)


def test_createJpg():
    dir_file = 'FF_UK0045_20230213_025919_082_0831744.fits'
    expname = 'FF_UK0045_20230213_025919_082_0831744.jpg'
    srcdir='ukml/pi/uk0045'
    camloc='redhill_e'
    cap_dir = os.path.join(basedir, srcdir)
